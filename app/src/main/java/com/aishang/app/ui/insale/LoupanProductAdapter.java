...
public class LoupanProductAdapter extends RecyclerView.Adapter<LoupanProductAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loupan_product, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        JLoupanProductListResult.Loupan loupan = loupanProducts.get(position).getLoupan();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(holder.getContext(), InSaleDetailActivity.class);
