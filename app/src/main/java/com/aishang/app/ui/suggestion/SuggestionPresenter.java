 ...
 */
public class SuggestionPresenter extends BasePresenter<SuggestionMvpView> {

  private final DataManager mDataManager;
  private Subscription subscription;

  @Inject public SuggestionPresenter(DataManager dataManager) {
    mDataManager = dataManager;
  }

  @Override public void attachView(SuggestionMvpView mvpView) {
  ...
  public void postData(boolean allowMemoryCacheVersion, int version, String json) {
    ...
    subscription = mDataManager.syncSuggestion(version, json)
