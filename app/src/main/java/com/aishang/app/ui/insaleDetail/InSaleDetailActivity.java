...
public class InSaleDetailActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(getIntent().getStringExtra(EXTRA_IMAGE)).into(image, new com.squareup.picasso.Callback() {
