...
public class SettingPresenter extends BasePresenter<SettingMvpView> {
  ...
  @Inject public SettingPresenter(DataManager dataManager) {
    mDataManager = dataManager;
  }

  @Override public void attachView(SettingMvpView mvpView) {
    super.attachView(mvpView);
  }

  public void logout(int version, String json) {
    logout(false, version, json);
  }

  public void logout(boolean allowMemoryCacheVersion, int version, String json) {
    checkViewAttached();
    ...
    subscription = mDataManager.syncMemberLogout(version, json)
