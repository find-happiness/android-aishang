package com.aishang.app.ui.building;
...
public class BuildingActivity extends AppCompatActivity {
  ...
  public static Intent getIntent(String title, Context ctx) {

    Intent intent = new Intent(ctx, BuildingActivity.class);
  ...
  private void initToolbar() {
    ...
    toolbarTitle.setText(this.getIntent().getStringExtra(TITLE));
