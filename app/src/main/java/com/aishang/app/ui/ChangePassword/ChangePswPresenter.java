 ...
 */
public class ChangePswPresenter extends BasePresenter<ChangePswMvpView> {

  private final DataManager mDataManager;
  private Subscription subscription;

  @Inject public ChangePswPresenter(DataManager dataManager) {
    mDataManager = dataManager;
  }

  @Override public void attachView(ChangePswMvpView mvpView) {
  ...
  public void postData(boolean allowMemoryCacheVersion, int version, String json) {
    ...
    subscription = mDataManager.syncPasswordChange(version, json)
